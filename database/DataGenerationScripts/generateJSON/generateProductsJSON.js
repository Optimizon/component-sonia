...
const similarProductGen = () => {
  const randomProductList = [];
  for(var i = 0; i < 11; i++) {
    randomProductList.push(Math.floor((Math.random() * 10000000) + 36))
  }
  return randomProductList;
}

// ZERO TO 3 MILL:
// var maxRecusions = 3000; 
// var currentRecursion = 0;

// var outer = function(){
// 	fs.writeFile('../../fakeProductData/asJson/productsWithSimilar1.json', '[', (err) => {
// 		if(err) throw err;
// 	})

// 	var innerRec = function(min, max){
// 		console.log("recurssion:", currentRecursion)
// 		currentRecursion++;
// 		if(maxRecusions < currentRecursion) {
// 			fs.appendFile('../../fakeProductData/asJson/productsWithSimilar1.json', ']', (err) => {
// 				if(err) throw err;
// 			})
// 			return;
// 		}
...
//             isPrime: randomBoolean(),
//             similarProducts: similarProductGen()
//           }

//       if(i === max - 1 && maxRecusions === currentRecursion){ //I'm at the end of the append chunk AND I'm at the final recursion
//         container = container + JSON.stringify(products) + `\n`
        
//       } else {
//         container = container + JSON.stringify(products) + ',' + `\n`
//       }
      
//       if(i === max - 1) { //i goes from 0 to 1000. if(i === 1000) append. Second time: i goes from 10001 to 2000. if(i === 2000)
// 				fs.appendFile('../../fakeProductData/asJson/productsWithSimilar1.json', container, (err)=>{ //append the entire container 
// 					if(err) throw err;
// 				})
// 			}
// 		}

// 		innerRec(min + 1000, max + 1000) //innerRec(1001, 20000) (2001, 3000), (30001, 40000)....
		

// 	}
//   innerRec(1, 1001) // appends lines 0 to 1000 (3000 times) //ends at 3 MILL
...
// var outer = function(){
// 	fs.writeFile('../../fakeProductData/asJson/productsWithSimilar2.json', '[', (err) => {
// 		if(err) throw err;
// 	})
...
// 		currentRecursion++;
// 		if(maxRecusions < currentRecursion) {
// 			fs.appendFile('../../fakeProductData/asJson/productsWithSimilar2.json', ']', (err) => {
// 				if(err) throw err;
// 			})
// 			return;
// 		}
...
// 			if(i === max - 1) { //gotten to the last line I will append 
// 				fs.appendFile('../../fakeProductData/asJson/productsWithSimilar2.json', container, (err)=>{ //append the entire container 
// 					if(err) throw err;
// 				})
// 			}
// 		}

// 		innerRec(min + 1000, max + 1000)
		

// 	}
//   innerRec(3000001, 3001001) //appending 1000 lines 2000 times ends at 6MILL
...
// var outer = function(){
// 	fs.writeFile('../../fakeProductData/asJson/productsWithSimilar3.json', '[', (err) => {
// 		if(err) throw err;
// 	})
...
// 		currentRecursion++;
// 		if(maxRecusions < currentRecursion) {
// 			fs.appendFile('../../fakeProductData/asJson/productsWithSimilar3.json', ']', (err) => {
// 				if(err) throw err;
// 			})
// 			return;
// 		}
...
// 			if(i === max - 1) { //gotten to the last line I will append 
// 				fs.appendFile('../../fakeProductData/asJson/productsWithSimilar3.json', container, (err)=>{ //append the entire container 
// 					if(err) throw err;
// 				})
// 			}
// 		}
...
// 	}
//   innerRec(6000001, 6001001) //appending 1000 lines 3000 times ends at 9MILL
...
//9MILL to 10MILL:
// // ** */ 9000001 to 10000000
// var maxRecusions = 1000; 
// var currentRecursion = 0;

// var outer = function(){
// 	fs.writeFile('../../fakeProductData/asJson/productsWithSimilar4.json', '[', (err) => {
// 		if(err) throw err;
// 	})
...
// 		currentRecursion++;
// 		if(maxRecusions < currentRecursion) {
// 			fs.appendFile('../../fakeProductData/asJson/productsWithSimilar4.json', ']', (err) => {
// 				if(err) throw err;
// 			})
// 			return;
// 		}
...
// 			if(i === max - 1) { //gotten to the last line I will append 
// 				fs.appendFile('../../fakeProductData/asJson/productsWithSimilar4.json', container, (err)=>{ //append the entire container 
// 					if(err) throw err;
// 				})
// 			}
// 		}
...
// 	}
//   innerRec(9000001, 9001001) //appending 1000 lines 000 times ends at 10MILL
